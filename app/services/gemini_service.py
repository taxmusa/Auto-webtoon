...
| 두번째 항목 | 설명 |
3~6개 행으로 작성하세요.""",
            "text_card": """3~5줄의 핵심 요약 문단으로 작성하세요.
각 줄은 별도의 줄바꿈으로 구분하세요.
첫 줄은 핵심 제목/결론이고, 나머지는 보충 설명입니다.
간결하고 임팩트 있게 작성하세요.""",
            "checklist": """체크리스트 항목 4~6개로 정리하세요.
반드시 아래 형식을 따르세요:
- 첫번째 항목 내용
- 두번째 항목 내용
- 세번째 항목 내용
각 항목은 짧고 명확한 한 문장으로 작성하세요. 기호는 - 만 사용하세요.""",
            "qa": """Q&A 3~4쌍으로 정리하세요.
반드시 아래 형식을 정확히 따르세요:
Q: 첫번째 질문 내용
A: 첫번째 답변 내용
...
각 Q와 A는 반드시 별도 줄에 작성하고, Q:와 A: 접두사를 정확히 사용하세요.
답변은 반드시 작성하세요. 비어있으면 안 됩니다.""",
            "steps": """단계별 가이드 3~5단계로 정리하세요.
반드시 아래 형식을 따르세요:
1. 첫번째 단계 설명
2. 두번째 단계 설명
3. 세번째 단계 설명
각 단계는 숫자. 으로 시작하고 한 문장으로 작성하세요.""",
