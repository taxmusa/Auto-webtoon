...
def run_debug(model_name="gemini-2.0-flash"):
...
if __name__ == "__main__":
    run_debug("gemini-1.5-pro") # Test fallback/alternative model choice
    run_debug("gemini-2.0-flash") # Test main model choice
